...
if __name__ == "__main__":
    ...
    parser.add_argument("--n-trees", type=int, default=3, help="batch size")
    ...
    parser.add_argument("--samples-per-image", type=int, default=2, help="number of samples per datapoint")
